...
>  教程来自苍梧月，仅发布于Linux.do及Github。该方法是抓包修改请求绕过限制，仅用于自有账号修复报错，请勿用于批量注册、违规爬取。
**注意：请勿相信任何第三方"在线修复工具"，相当于将自己手机大门打开，将信息都流到对方手中(包含但不限于所有软件记录、账号密钥等)，谨防信息泄露，最安全的方法只有自己动手操作。**
## 前置条件
